...
1. **Regex / OpenRefine assignment** (Week 8)
2. **Danish kings assignment** (Week 11)
3. **Visualisation assignment** (Week 13)
4. **Digital archives reflection** (Week 17)
5. **Final digital project** — *Sterilization by Design*
